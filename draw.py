...
plt.scatter(x1, y1, s=20,c='black',marker='x', alpha=1, label='fullCluster')
plt.scatter(x2, y2, s=20,c='black',marker='s', alpha=1, label='lowCluster')
